...
public class UsersController {
	...
	@GetMapping("home")
	public String home() {
		System.out.println("RestApiController.home");
		return "<h1>home</h1>";
	}
...
유저 혹은 매니저 혹은 어드민이 접근 가능
curl -H "Authorization: Bearer eyJhbGciOiJIUzI1NiJ9.eyJ1c2VybmFtZSI6Im1hc3VuZ2lsIiwiaWQiOjEwLCJleHAiOjE2OTEzMTg5NjV9.v4mmu4PEGJNosjTAc9vjbkHXhhezVDV7ipzj9hI_C7g" http://localhost:8090/api/v1/user
*/
